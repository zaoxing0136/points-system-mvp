(function () {
  ...
  function buildPreviewRecords(student) {
    ...
    return [
      { rule_name_snapshot: '专注听课', category_snapshot: 'classroom', points_delta: 1, action_type: 'add', created_at: new Date(baseTime + 86400000).toISOString(), remark: '进入状态很快' },
